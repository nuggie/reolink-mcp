...
# suppressed while the camera's audio-alarm feature is disabled. `save_preset`
# (the write-side counterpart to `ptz_move_to_preset`/`list_presets`) was
# added later as a locally-maintained fork addition.
